...
The Priest Spell List table contains a short summary of the spells available to all Priest, ordered by aether cost. The Details column may contain any of the following symbols:
\begin{itemize}
...
\onecolumn
\begin{DndTable}[header=Priest Spell List]{XXY}
	...
	2 & \nameref{spell:bane} & \textbf{CHA}, \copyright 1 minute \\
	2 & \nameref{spell:bless} & \\
	...
	3 & \nameref{spell:aid} & Bonus hp/max hp, 8 hours \\
	...
	5 & \nameref{spell:beacon-of-hope} & $\odot$, \copyright 1 minute \\
	5 & \nameref{spell:bestow-curse}, \copyright 1 minute \\
