...
\subparagraph*{Gibbering Mouther}
...
\begin{multicols}{2}
	...
	\begin{DndMonster}{Mkhulu (template)}
	\DndMonsterAction{Type} The type of the creature changes to aberration. The size remains unchanged. It gains the Individualistic trait.
	\DndMonsterAction{Hit Points} The creature's hit points increase to a minimum of 91 (14d8 + 28). If they are already higher, they remain unchanged.
	\DndMonsterAction{Speed} The creature gains a swimming speed of 30 ft.
	\DndMonsterAction{Ability Scores} The creature's ability scores change as follows:
	\begin{itemize}
	...
	\end{itemize}
	\DndMonsterAction{Traits} The creature gains the following traits:
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\DndMonsterAction{Actions} The creature gains the following actions.
	\begin{itemize}
