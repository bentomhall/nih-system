...
\noindent\textbf{Hit Dice:} 1d8 per spellblade level

\noindent\textbf{Hit Points at 1st Level:} 8 + your Constitution modifier

\noindent\textbf{Hit Points at Higher Levels:} 1d8 (or 5) + your Constitution modifier per spellblade level after 1st

\subsubsection{Proficiencies}

\noindent\textbf{Armor:} Light armor, medium armor

\noindent\textbf{Weapons:} Simple weapons, hand crossbows, longswords, rapiers, shortswords

\noindent\textbf{Tools:} Three musical instruments of your choice

\noindent\textbf{Saving Throws:} Dexterity, Charisma

\noindent\textbf{Skills:} Choose any three
