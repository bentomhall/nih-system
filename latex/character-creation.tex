...
\begin{enumerate}
	...
	\item \textbf{Dexterity (DEX):} Someone with high DEX is good at tasks requiring a delicate, precise approach. Ranged weapons, stealth, feats of acrobatics, pick-pocketing, and acting first in combat are all governed by Dexterity. Such characters are often described as "quick" or "nimble". Rangers and rogues are particularly likely to have high DEX, as well as brawlers. Ranged weapon attacks use DEX as their modifier. Most "big explosion" spells and effects require DEX saves to reduce or eliminate the effect. Light armor relies on having a high DEX to dodge, rather than outright block, incoming attacks.
