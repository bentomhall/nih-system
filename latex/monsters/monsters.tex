...
Monsters have an attitude listed that describes how a generic member of that type of monster will act by default. Specific individuals may act differently, but this serves as a guide to role play for the GM. Example attitudes:
...
A monster with truesight can, out to a specific range, see in normal and magical darkness, see invisible creatures and objects, automatically detect visual illusions and succeed on saving throws or ability checks against them, and perceive the original form of a shapechanger or a creature that is transformed by magic. Furthermore, the monster can see into the Ethereal Plane within the same range.
...
See the \smartnameref{ch:equipment}{Equipment in the main rules} for rules on using armor without proficiency.

Monsters conditionally apply their additional bonus to attack rolls, as described above. This same bonus should apply to all attacks if it applies to any, and the game goes more smoothly if all relevant numeric bonuses are listed in the monster entry.
