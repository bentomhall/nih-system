...
If you are using the classes, lineages, and backgrounds presented in the other Dawn of Hope setting materials, they grant skill tricks as regular features.

Characters with classes from elsewhere gain a Skill Trick every time the character gets an Ability Score Increase. Some of them overlap with bullet points from printed feats. It is up to the player to decide, but generally you cannot benefit from both at the same time (i.e. they do not stack). Additionally, you can trade one skill trick you know for a different one you qualify for whenever you gain a new skill trick.

Additionally, the GM can grant skill tricks as rewards for quests or for spending downtime training. None of them should give substantial *mechanical* benefit.

Character level | Skill Trick
:----|:----:
1 - 9 | Basic
9 - 12 | Advanced
13 - 16 | Expert
...
Rogues and (to a much lesser degree) bards are skill monkeys. As such, skill tricks are right up their alley. Warlocks, being the weird ones that they are, also have aptitude this way.

#### Skill Versatility (Optional Rogue Feature)
At 2nd, 3rd, 6th, and 18th level (in addition to every time you gain an ability score increase), you gain an additional skill trick. You do not need to meet the skill or ability score requirements for skill tricks gained this way.

In addition, you can learn Advanced skill tricks at starting at 8th level (instead of 9th level), and Expert skill tricks at 12th level (instead of 13th level).

#### Bardic Skills (Optional Bard Feature)
At 2nd level, you gain a Basic skill trick. You do not have to meet the skill or ability score requirements for this trick.

In addition, you can learn Advanced skill tricks starting at 8th level (instead of 9th level).

#### Eldritch Skills (Optional Warlock Invocation)
*Requires 4th level*

You gain a skill trick you qualify for. You can select this invocation multiple times, choosing a different skill trick each time.

## Basic Skill Tricks

Basic skill tricks only require a +2 proficiency.
...
You lash out with your shield. As an action, make a proficient melee weapon attack using Strength. On a hit, the opponent takes 1d4 + your Strength modifier bludgeoning damage and is staggered until the end of their next turn. If you score a critical hit, the target is staggered until the end of your next turn. This can replace an attack when you take the Attack action.
...
## Appendix: New conditions referenced
