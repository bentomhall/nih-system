...
Starting at level 11, creatures who benefit from this gain temporary hit points equal to your level.
...
\subsubsection{Staunch the Bleeding}
Starting at 10th level, you've learned to provide effective emergency medicine. As bonus action, expend 2 STA and 2 AET and touch a creature. That creature regains hit points as if they had spent 3 hit dice (but do not expend hit dice). If the creature was bloodied, they regain maximum hit points instead.
...
%planning:
%3: Command: Strike (give up attack to allow an ally to reaction-attack OR spend a reaction to allow someone else to reroll an attack)
%3: Command: Hustle (bonus action to allow ally to move without provoking)
%7: Inspire Courage: condition removal/protection (fear, stagger, shaken)
%7: Staunch Bleeding: Touch heal, extra effective on downed characters
%10: Supporting Arguments: Allies who can hear you add your CHA mod to social checks, you get expertise in one social
%15: Leave No One Behind: Can take ally along when you Flash Step, costs AET
%18: LE: Glibness + LE: Heroes Feast
%18 (Alternate): Area heal on deathblow