...
\textbf{Alice:} With a +2 Constitution, that gives me 10 HP. Leather with a +2 Dexterity gives me an AC of 13. +3 Wisdom and +2 proficiency means my spellcasting DC is 8 + 3 + 2 = 13. My spell attack modifier is 3 + 2 = 5. I've got only one hit die, so 1d8. I've got 1 Stamina, 4 Aether, and an aether limit of 2. With weapons...Strength is not my strong suit (pun intended). Melee attack modifier is -1 + 2 = 1 and damage is 1d6 - 1. For the crossbow, that uses Dexterity since it's ranged. Ranged attack modifier is +2 + 2 = +4 and damage is 1d8 + 2. \textit{She writes these down on the character sheet.} Ok, I think that's enough for me to start play.
