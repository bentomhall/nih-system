...
\subparagraph*{Hit Dice} 1d10 per armsman level

\subparagraph*{Hit Points at 1st Level} 10 + your Constitution modifier

\subparagraph*{Hit Points at Higher Levels} 1d10 (or 6) + your Constitution modifier per armsman level after 1st

\subsubsection{Proficiencies}

\subparagraph*{Armor} All armor, shields

\subparagraph*{Weapons} All weapons

\subparagraph*{Tools} None

\subparagraph*{Saving Throws} Strength, Constitution

\subparagraph*{Skills} Choose two skills from Acrobatics, Animal, Handling, Athletics, History, Insight, Intimidation, Perception, and Survival
...
\begin{itemize}
	\item You can use your Melee Attack Modifier when attacking with ranged weapons.
	...
	\item You can choose to make a Strength check when a Dexterity check would otherwise be called for and vice versa. Any specified proficiency still applies.
...
\begin{figure}[htb]
\begin{DndTable}[header=Sword Saint]{lc}
	\textbf{Armsman Level} & \textbf{Aether Limit} \\ 
	3  & 1 \\
	4  & 2 \\
	7  & 3 \\
	13 & 5 \\
...
You've learned to provide effective emergency medicine. As bonus action, expend 2 STA and 1 AET and touch a creature. That creature regains hit points as if they had spent 1 hit die (but do not expend the hit die). If the creature was bloodied, they regain hit points as if they'd rolled the maximum value of their hit die instead.
...
\begin{itemize}
	...
	\item \textbf{Skirmishing:} Once during the duration, affected creatures can move a distance in feet up to 5 times your Charisma modifier as a reaction without provoking Opportunity Attacks.
