...
\subsubsection{Elemental Rage}
At 3rd level when you pick this Path, choose one of the elements below. You gain the listed feature while you are raging.
\subparagraph*{Lava} You gain resistance to fire damage. If a creature you can see hits you with an attack, you can use your reaction and spend 1 AET to deal 1d10 plus your Constitution modifier fire damage to them.
\subparagraph*{Ice} You gain resistance to cold damage. If a creature you can see hits you with an attack, you can use your reaction and spend 1 AET to reduce their movement speed by half until the end of their next turn.
\subparagraph*{Lightning} You gain resistance to lightning damage. If a creature you can see within 30 feet is targeted by an attack, you can use your reaction and spend 1 AET to teleport to an unoccupied space within 5 feet of them and become the target of the attack instead.

\subsubsection{Elemental Blow}
...
\subsubsection{Legendary Effect: Control Weather}
At 14th level you learn the legendary effect \nameref{spell:control-weather} and can use it once per long rest.
