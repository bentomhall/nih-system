...
Beginning at 5th level, you've learned to carry some of the momentum from attack to attack, amplifying the effects of the blows. Each time you hit a target with a weapon attack during one of your turns, you can spend 1 STA to gain a Momentum point. If you spent STA as part of the attack, you gain a Momentum point for no additional cost. You can expend these Momentum points on any hit after your first in a given turn. Each Momentum point spent increases the damage dealt by 1d4. Unspent Momentum fades after one minute of not making any attacks.
