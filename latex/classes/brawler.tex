...
\subparagraph*{Weapons} Simple weapons, shortswords

\subparagraph*{Tools} Choose one type of artisan's tools or one musical instrument

\subparagraph*{Saving Throws} Strength, Dexterity

\subparagraph*{Skills} Choose two from Acrobatics, Athletics, History, Insight, Religion, and Stealth
...
\begin{itemize}
\item You can use your Ranged Attack Modifier for all weapon attacks with proficient weapons and unarmed strikes. When you do so, you add your Dexterity modifier to the damage dealt instead of your Strength modifier.
\item You can use Dexterity (Acrobatics) instead of Strength (Athletics) when making a shove or grapple attempt.
...
\subsection{Way of the Serpent Dance}
...
\subsubsection{Serpent's Charm}
When you pick this subclass at level 3, you gain proficiency in Deception. If you already had proficiency, you gain expertise instead. In addition, you learn the \nameref{st:feint} skill trick. If you spend STA on a different bonus action granted by this class, you can use Feint as part of the same bonus action, expending stamina as usual.

\subsubsection{Serpent's Venom}
...
\subsubsection{Necrotic Venom}
Starting at 11th level, the poison damage dealt by your Serpent's Venom ability becomes necrotic in addition to poison. Remember, this means that a creature must be resistant or immune to both necrotic and poison to be immune to the damage. In addition, creatures immune to the \nameref{condition:poisoned} condition become \nameref{condition:staggered} instead.

\subsubsection{Legendary Transformation}
At 17th level, you learn the legendary effect \nameref{spell:animal-shapes} and can use it once per long rest. You can only choose serpentine forms, but affected creatures gain temporary hit points equal to your Wisdom modifier + your proficiency bonus.
