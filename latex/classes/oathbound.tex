...
\noindent\textbf{Hit Dice:} 1d10 per oathbound level

\noindent\textbf{Hit Points at 1st Level:} 10 + your Constitution modifier

\noindent\textbf{Hit Points at Higher Levels:} 1d10 (or 6) + your Constitution modifier per oathbound level after 1st

\subsubsection{Proficiencies}

\noindent\textbf{Armor:} All armor, shields

\noindent\textbf{Weapons:} Simple weapons, martial weapons

\noindent\textbf{Tools:} None

\noindent\textbf{Saving Throws:} Wisdom, Charisma

\noindent\textbf{Skills:} Choose two from Athletics, Insight, Intimidation, Medicine, Persuasion, and Religion
...
Starting at 3rd level, you can expend 10 hit points of your Lay on Hands pool to remove the staggered, stunned, shaken, frightened, or broken conditions. Alternatively, you can expend 5 points to remove the condition in question, but become afflicted with it instead, using the remaining duration, saving throw, and any other effects.
