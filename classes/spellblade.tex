...
At 14th level, you learn the legendary effect \nameref{spell:mirage-arcane} and can use it once per day.

\subsubsection{Legendary Effect: Glibness}
At 18th level, you learn the legendary effect \nameref{spell:glibness} and can use it once per day.
