...
\noindent\textbf{Hit Dice:} 1d8 per shaman level

\noindent\textbf{Hit Points at 1st Level:} 8 + your Constitution modifier

\noindent\textbf{Hit Points at Higher Levels:} 1d8 (or 5) + your Constitution modifier per shaman level after 1st

\subsubsection{Proficiencies}

\noindent\textbf{Armor:} Light armor, medium armor, shields

\noindent\textbf{Weapons:} Clubs, daggers, darts, javelins, maces, quarterstaffs, scimitars, sickles, slings, spears

\noindent\textbf{Tools:} Herbalism kit

\noindent\textbf{Saving Throws:} Intelligence, Wisdom

\noindent\textbf{Skills:} Choose two from Arcana, Animal Handling, Insight, Medicine, Nature, Perception, Religion, and Survival
