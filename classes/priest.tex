...
\begin{itemize}
\item (\texit{a}) a mace or (\texit{b}) a warhammer (if proficient)
\item (\texit{a}) scale mail, (\texit{b}) leather armor, or (\texit{c}) chain mail (if proficient)
\item (\texit{a}) a light crossbow and 20 bolts or (\texit{b}) any simple weapon
\item (\texit{a}) a priest’s pack or (\texit{b}) an explorer’s pack
