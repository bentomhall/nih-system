...
\subparagraph*{Expended Currency} Money or Favors. Research costs money. You can expend 100 gp to guarantee a successful workweek of Research. Knowing the right people can also help get access to materials.
...
\subparagraph*{Associated Currency} Discoveries. Sometimes you learn things about people that can be leveraged.
...
\begin{enumerate}
  ...
  \item[] Weapon: Use the main attack ability (STR for melee, DEX for ranged).
\end{enumerate}
