...
\begin{figure*}[htb]
\begin{DndTable}[header=The Priest\label{tbl:priest}]{llXcccccc}
...
\begin{DndTable}[header=Miracle Outcomes,width=0.5\linewidth]{lX}
...
\begin{figure*}[htb]
\begin{DndTable}[header=Priest Spell List,width=0.75\linewidth]{rlXrl}
