...
\begin{DndMonster}{Chuul}
	...
	\DndMonsterAction{Sense Magic} The chuul senses magic within 120 feet of it at will. This trait otherwise works like the Sense Aura incantation but isn't itself magical.
...
\begin{DndMonster}[float*=b,width=\textwidth + 8pt]{Guardian Naga}
	...
	\begin{itemize}
		\item[] \textbf{Concentration} \textit{banishment} (2x), \textit{shield of faith} (1x), \textit{bestow curse} (1x), \textit{arcane binding} (2x)
		\item[] \textbf{Healing} \textit{cure wounds} (3x)
		\item[] \textbf{Damage} \textit{flame strike} (1x)
	\end{itemize}
...
\begin{DndMonster}[float*=b,width=\textwidth + 8pt]{Spirit Naga}
	...
	\begin{itemize}
		\item[] \textbf{Concentration} \textit{domination} (Legendary, 1x), \textit{arcane binding} (3x)
		\item[] \textbf{Damage} \textit{blight} (2x), \textit{lightning bolt} (2x)
		\item[] \textbf{Other} \textit{dimension door} (1x)
	\end{itemize}
