...
With this action, you make one melee or ranged weapon attack. See the \nameref{sec:making-an-attack} section for the rules that govern attacks.
...
When a creature can't see you, you have advantage on attack rolls against it. If you are \nameref{condition:hidden} from one or more creatures when you make an attack, that condition ends after the attack is complete whether it hits or misses.
