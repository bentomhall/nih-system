...
\begin{DndTable}[header=Oathbound Spell List]{XXY}
	...
	8 & \nameref{freedom-of-movement} & Prevent restraint, 1 ally, 1 hour \\
	9 & \nameref{mass-cure-wounds} & 3d8 + MOD healing, 6 allies, $\bigcirc$ \\

	12 & \nameref{dispel-otherworldly-influence} & Protect against otherplanar, self, \copyright 1 minute \\
