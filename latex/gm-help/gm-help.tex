...
\begin{itemize}
    ...
    \item If it's just set dressing. A dragon doing a drive-by flaming of a camp of guards and commoners just kills however many of them as is thematically appropriate.
\end{itemize}
