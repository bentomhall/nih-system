...
\begin{DndTable}[header=Typical Difficulty Classes,width=0.5\linewidth]{XX}
...
\begin{DndTable}[header=Travel Pace,width=0.75\linewidth]{XXXXX}
...
\begin{DndTable}[header=Common visibility ranges,width=0.7\linewidth]{Xll}
...
\begin{figure*}[!ht]
\begin{DndTable}[header=Normal Hearing Range,width=0.5\linewidth]{Xl}
...
\begin{DndTable}[header=Size Categories,width=0.5\linewidth]{lX}
    Size & Space \\
...
For example, a priest with a maximum of 12 hit points currently has 6 hit points. If she takes 18 damage from an attack, she is reduced to 0 hit points, but 12 damage remains. Because the remaining damage equals her hit point maximum, the cleric dies.
...
\begin{figure*}[htb]
\begin{DndTable}[header=Object Armor Class,width=0.5\linewidth]{Xl}
...
\begin{figure*}
\begin{DndTable}[header=Object Hit Points,width=0.5\linewidth]{Xll}
