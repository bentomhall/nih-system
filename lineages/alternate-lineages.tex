\chapter{Alternate Lineage Development}\label{ch:alternate-lineage-construction} 
...
\subsection{Ihmisi (aka wood elf)} \label{lineage:ihmisi}
...
\subsection{Gwerin (aka high elves)} \label{lineage:gwerin}
