...
\DndSpellHeader{Ray of Enfeeblement}
{3 AET}
{1 action}
{60 feet}
{V, S}
...
A black beam of enervating energy springs from your finger toward a creature within range. Make a ranged spell attack against the target. On a hit, the target takes 3d6 necrotic damage and deals only half damage with weapon attacks until the spell ends.

At the end of each of the target's turns, it can make a Constitution saving throw against the spell. On a success, the spell ends.

\subparagraph*{Overcast} When you cast this spell using more than 3 AET, the damage increases by 1d6 for every 2 additional aether spent.

\label{spell:ray-of-frost}
\DndSpellHeader{Ray of Frost}
{cantrip}
{1 action}
{60 feet}
{V, S}
...
\DndSpellHeader{Resilient Sphere}
{8 AET}
{1 action}
{30 feet}
...
\DndSpellHeader{Spirit Guardians}
{5 AET}
{1 action}
{Self (15-foot radius)}
{V, S, M (a holy symbol)}
...
\DndSpellHeader{Spiritual Weapon}
{3 AET}
{1 bonus action}
{60 feet}
{V, S}
...
You create a floating, spectral weapon within range that lasts for the duration or until you cast this spell again. When you cast the spell, you can make a melee spell attack against a creature within 5 feet of the weapon. On a hit, the target takes bludgeoning, piercing, or slashing (your choice) damage equal to 1d8 + your spellcasting ability modifier.
...
\subsection*{Overcast} When you cast this spell using more than 3 AET, the damage increases by 1d8 for every two additional AET.

\label{spell:stinking-cloud}
\DndSpellHeader{Stinking Cloud}
{5 AET}
{1 action}
{90 feet}
...
\label{spell:wind-wall}
\DndSpellHeader{Wind Wall}
{5 AET}
{1 action}
{120 feet}
