\subsection{Spells (A)}
\label{spell:acid-arrow}
\DndSpellHeader{Acid Arrow}
{3 AET}
{1 action}
{90 feet}
...
\subparagraph*{Overcast} When you cast this spell using more than 3 AET, the damage (both intial and subsequent) increases by 1d4 for every 2 AET you spend above 3.

\label{spell:acid-burst}
\DndSpellHeader{Acid Burst}
{Cantrip}
{1 action}
{60 feet}
{V, S}
...
\label{spell:alter-self}
\DndSpellHeader{Alter Self}
{3 AET}
{1 action}
{Self}
{V, S}
...
\label{spell:antilife-shell}
\DndSpellHeader{Antilife Shell}
{10 AET}
{1 action}
{Self (10-foot radius)}
{V, S}
...
\label{spell:arcane-eye}
\DndSpellHeader{Arcane Eye}
{8 AET}
{1 action}
{30 feet}
...
\subparagraph*{Overcast} When you cast this spell using more than 4 AET, you can target one additional creature for every 2 extra AET you spend above the base cost.

\label{spell:banishment}
\DndSpellHeader{Banishment}
{8 AET}
{1 action}
{60 feet}
{V, S}
...
\label{spell:beacon-of-hope}
\DndSpellHeader{Beacon of Hope}
{5 AET}
{1 action}
{30 feet}
{V, S}
...
\label{spell:bestow-curse}
\DndSpellHeader{Bestow Curse}
{5 AET}
{1 action}
{Touch}
{V, S}
...
\subparagraph*{Overcast} If you cast this spell using 8 AET, the duration is concentration, up to 10 minutes. If you use 12 AET,the duration is 8 hours. If you use 16 AET, the duration is 24 hours. If you use 20 AET the spell lasts until it is dispelled. Using 12 or more AET grants a duration that doesn't require concentration.

\label{spell:black-tentacles}
\DndSpellHeader{Black Tentacles}
{8 AET}
{1 action}
{90 feet}
...
\label{spell:blindness-deafness}
\DndSpellHeader{Blindness/Deafness}
{3 AET}
{1 action}
{30 feet}
{V}
...
\label{spell:call-lightning}
\DndSpellHeader{Call Lightning}
{5 AET}
{1 action}
{120 feet}
{V, S}
...
A creature that can see the sensor (such as a creature benefiting from \textit{see invisibility} or who has truesight) sees a luminous, intangible orb about the size of your fist. The sensor has an AC of 10 and is destroyed by any damage taken.

\label{spell:cloudkill}
\DndSpellHeader{Cloudkill}
{12 AET}
{1 action}
{120 feet}
{V, S}
...
\label{spell:color-spray}
\DndSpellHeader{Color Spray}
{2 AET}
{1 action}
{Self (15-foot cone)}
...
\subparagraph*{Overcast} When you cast this spell using more than 2 AET, roll an additional 1d10 for every additional AET spent.
...
\label{spell:cone-of-cold}
\DndSpellHeader{Cone of Cold}
{12 AET}
{1 action}
{Self (60-foot cone)}
...
\label{spell:conjure-animals}
\DndSpellHeader{Conjure Animals}
{5 AET}
{1 action}
{60 feet}
{V, S}
...
\item 12 AET spent: 1 elephant or 2 of the CR 3 options.
\end{itemize}

\label{spell:conjure-elemental}
\DndSpellHeader{Conjure Elemental}
{12 AET}
{1 minute}
{90 feet}
...
\label{spell:conjure-mephits}
\DndSpellHeader{Conjure Mephits}
{8 AET}
{1 minute}
{90 feet}
{V, S}
...
\label{spell:conjure-woodland-beings}
\DndSpellHeader{Conjure Woodland Beings}
{8 AET}
{1 action}
{60 feet}
...
\label{spell:control-water}
\DndSpellHeader{Control Water}
{8 AET}
{1 action}
{300 feet}
...
\label{spell:create-or-destroy-water}
\DndSpellHeader{Create or Destroy Water}
{2 AET}
{1 action}
{30 feet}
...
\subparagraph*{Overcast} When you cast this spell using more than 2 AET, the healing increases by 1d8 for every additional AET spent, up to a maximum of 12d8 + your spellcasting ability modifier.

\subsection{Spells (D)}

\label{spell:dancing-lights}
...
\label{spell:daylight}
\DndSpellHeader{Daylight}
{5 AET}
{1 action}
{60 feet}
{V, S}
...
\label{spell:death-ward}
\DndSpellHeader{Death Ward}
{8 AET}
{1 action}
{Touch}
{V, S}
...
\label{spell:dimension-door}
\DndSpellHeader{Dimension Door}
{8 AET}
{1 action}
{500 feet}
{V}
...
\label{spell:dispell-evil-or-good}
\DndSpellHeader{Dispel Evil or Good}
{12 AET}
{1 action}
{Self}
...
\label{spell:dispel-magic}
\DndSpellHeader{Dispel Magic}
{5 AET}
{1 action}
{120 feet}
{V, S}
...
\subparagraph*{Overcast} When you cast this spell using a spell slot of 4th level or higher, you automatically end the effects of a spell on the target if the spell's level is equal to or less than the level of the spell slot you used.

\label{spell:divine-favor}
\DndSpellHeader{Divine Favor}
{2 AET}
{1 bonus action}
{Self}
{V, S}
...
\label{spell:dominate-beast}
\DndSpellHeader{Dominate Beast}
{8 AET}
{1 action}
{60 feet}
{V, S}
...
\subparagraph*{Overcast} When you cast this spell with a 5th-level spell slot, the duration is concentration, up to 10 minutes. When you use a 6th-level spell slot, the duration is concentration, up to 1 hour. When you use a spell slot of 7th level or higher, the duration is concentration, up to 8 hours.
...
\subparagraph*{Overcast} When you cast this spell using a 6th-level spell slot, the duration is concentration, up to 10 minutes. When you use a 7th-level spell slot, the duration is concentration, up to 1 hour. When you use a spell slot of 8th level or higher, the duration is concentration, up to 8 hours.

\subsection{Spells (E)}

\label{spell:enhance-ability}
\DndSpellHeader{Enhance Ability}
{3 AET}
{1 action}
{Touch}
...
\label{spell:expeditious-retreat}
\DndSpellHeader{Expeditious Retreat}
{2 AET}
{1 bonus action}
{Self}
{V, S}
...
\label{spell:faerie-fire}
\DndSpellHeader{Faerie Fire}
{2 AET}
{1 action}
{60 feet}
{V}
...
\label{spell:faithful-hound}
\DndSpellHeader{Faithful Hound}
{8 AET}
{1 action}
{30 feet}
...
\label{spell:false-life}
\DndSpellHeader{False Life}
{2 AET}
{1 action}
{Self}
...
\subparagraph*{Overcast} When you cast this spell using a spell slot of 2nd level or higher, you gain 5 additional temporary hit points for each slot level above 1st.
...
\label{spell:feather-fall}
\DndSpellHeader{Feather Fall}
{2 AET}
...
\label{spell:fire-shield}
\DndSpellHeader{Fire Shield}
{8 AET}
{1 action}
{Self}
...
\label{spell:flame-blade}
\DndSpellHeader{Flame Blade}
{3 AET}
{1 bonus action}
{Self}
{V, S, M (leaf of sumac)}
...
\subparagraph*{Overcast} When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for every two slot levels above 2nd.

\label{spell:flame-strike}
\DndSpellHeader{Flame Strike}
{12 AET}
{1 action}
{60 feet}
...
\subparagraph*{Overcast} When you cast this spell using a spell slot of 6th level or higher, the fire damage or the radiant damage (your choice) increases by 1d6 for each slot level above 5th.

\label{spell:flaming-sphere}
\DndSpellHeader{Flaming Sphere}
{3 AET}
{1 action}
{60 feet}
...
\subparagraph*{Overcast} When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d6 for each slot level above 2nd.

\label{spell:fog-cloud}
\DndSpellHeader{Fog Cloud}
{2 AET}
{1 action}
{120 feet}
{V, S}
...
\subparagraph*{Overcast} When you cast this spell using a spell slot of 2nd level or higher, the radius of the fog increases by 20 feet for each slot level above 1st.

\label{spell:freedom-of-movement}
\DndSpellHeader{Freedom of Movement}
{8 AET}
{1 action}
{Touch}
...
\label{spell:gaseous-form}
\DndSpellHeader{Gaseous Form}
{5 AET}
{1 action}
{Touch}
...
\label{spell:giant-insect}
\DndSpellHeader{Giant Insect}
{8 AET}
{1 action}
{30 feet}
{V, S}
...
\label{spell:grave-touch}
\DndSpellHeader{Grave Touch}
{cantrip}
{1 action}
{120 feet}
{V, S}
...
\label{spell:greater-invisibility}
\DndSpellHeader{Greater Invisibility}
{8 AET}
{1 action}
{Touch}
{V, S}
...
\subparagraph*{Overcast} When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d6 for each slot level above 1st.

\label{spell:gust-of-wind}
\DndSpellHeader{Gust of Wind}
{3 AET}
{1 action}
{Self (60-foot line)}
{V, S, M (a legume seed)}
