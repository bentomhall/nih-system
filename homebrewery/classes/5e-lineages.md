...
## A framework and implementation for Dawn of Hope
...
Your character's lineage describes their biological heritage. Are they one of the tall, long-lived gwerin (ie high elf)? Or a human? Or a draconic-souled dragonborn? Or one of many other lineages. Each lineage grants a few features, including giving a +1 to one ability score. It also describes the common heights, weights, appearance, etc. of members of that lineage.

A character's culture describes where in the world they come from and what kind of culture they grew up with. Some cultures are more generic and others more narrow; pick what fits your character best after consultation with the GM. Each culture gives a set of features, including a +2 to one ability score. You can't pick the same ability score for this +2 as you did from your lineage. If they would overlap, pick a different one of your choice. After including both changes, no ability score can be greater than 20.
...
{{note
#### Converting a 5e race to lineages
To convert a 5e race (including subrace) to the Lineage/Culture framework, you will need to do the following:
- Decide what the ability score increase will be. Replace the existing ASI with +1 to that ability score (or a choice of two).
- Remove anything that isn't at least plausibly (in a fantasy world) biological in origin. Cultural traits (such as the elven weapon training) go into cultures.
- Decide what feature, if any, should be replaced if the race becomes "touched". Note this with a (+) after the name.
}}
...
{{note
#### Creating a Culture for your setting
Cultures are inherently tied to settings. The ones presented here are adapted to Dawn of Hope (other than the generic ones). You can use them as examples when creating your own.
}}
...
**Coin Counter.** Any time you sell goods, you get 125% of the normal price, and you buy for 90% of the listed price.

**Babyl-dweller.** You know the *comprehend languages* spell and can cast it as a ritual. If you have appropriate spell slots, you can cast it using spell slots as well.
...
**Region.** Any with significant bodies of water.

**Ability Score Increase.** +1 Dexterity OR  +1 Strength

**Languages.** Sarthak (ship speech) OR Metsae (ihmisi) OR Yonwach (gwerin)
...
**Region.** Any wilderness away from civilization
...
**Ascendant Guidance.** You learn the *augury* spell and can cast it as a ritual. If you have appropriate spell slots, you can cast it using spell slots as well.

**Ritualist.** When you cast a spell that has a cast time greater than 1 minute, you can reduce it by one step (to a minimum of one minute). The steps are 1 minute, 10 minutes, 1 hour, 8 hours, 12 hours, 24 hours.
...
**Region.** Dreamshore, Sea of Grass, Southshore
...
**Children of the Congregation.** You learn a cantrip of your choice from the Cleric list. Wisdom is the casting ability for this cantrip.
...
This list only describes basic skill tricks, which are the only ones accessible at character creation via class, lineage, culture, or background.
...
As a bonus action you take when you take the Attack action and attack a target, you can allow another creature of your choice that can hear you to use their reaction to make a weapon attack against that same target. If they hit, they deal additional damage equal to your proficiency bonus. Once you use this feature a number of times equal to your Charisma modifier, you cannot do so again until you finish a long or short rest.
...
*Strength or Dexterity (Martial Weapon) Basic Skill Trick*
...
When you are targeted by an opportunity attack, you can use your reaction to add your proficiency bonus to your armor class against that attack. Once you use this feature a number of times equal to your Dexterity modifier (minimum 1), you cannot do so again until you finish a long or short rest.

#### Feint

*Charisma (Deception) Basic Skill Trick*

You fake an attack as a bonus action, trying to misdirect the enemy. The opponent must make a Wisdom saving throw. On a failed save, you have advantage on your next attack roll against them. Once you use this feature a number of times equal to your Charisma modifier (minimum 1), you cannot do so again until you finish a long or short rest.

#### Frighten 

*Charisma (Intimidation) Basic Skill Trick*

As an action, you can threaten one enemy that can hear you. The target must make a Charisma saving throw. On a failed save, they are frightened of you until the end of your next turn. Once you use this feature a number of times equal to your Charisma modifier (minimum 1), you cannot do so again until you finish a long or short rest.
...
You can hold your breath for twice as long. In addition, you have advantage on Constitution saving throws against poison gas (such as cloudkill or a dretch's Stench ability). 
...
When you are hidden, you can use a bonus action to force a number of creatures equal to your proficiency bonus to make a Wisdom saving throw. On a failure, they do not notice you even if you move out of heavy obscurement, as long as you end your turn behind heavy obscurement. Once you use this feature a number of times equal to your Dexterity modifier (minimum 1), you cannot do so again until you finish a long or short rest.

#### Piercing Wound

*Dexterity (Martial Weapon) Basic Skill Trick*

When you hit with an attack from a ranged weapon or a finesse weapon, you can try to hamper the offense of the opponent. The target must make a Constitution saving throw. On a failed save, their next weapon attack is at disadvantage. Once you use this feature a number of times equal to your Dexterity modifier (minimum 1), you cannot do so again until you finish a long or short rest.

#### Primal Initiate

*Wisdom (Nature) Basic Skill Trick*

You learn one cantrip of your choice from the Druid list, as well as one spell of 1st level. Wisdom is your casting ability for these spells. You can pick this skill trick more than once. Each time you do, pick a different cantrip and spell.
...
You lash out with your shield as an action. Make an attack, treating the shield as a martial melee weapon with which you have proficiency. On a hit, the opponent takes 1d4 + your Strength modifier bludgeoning damage and is staggered until the end of their next turn. If you score a critical hit, the target is staggered until the end of your next turn. This can replace an attack when you take the Attack action. Once you use this feature a number of times equal to your Strength modifier, you cannot do so again until you finish a long or short rest.

A staggered creature has disadvantage on attack rolls, disadvantage on Dexterity saving throws and ability checks, and targets of a staggered creature's spells or abilities have advantage on saving throws against those abilities.
