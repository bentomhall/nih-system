...
Proficiency in a language includes the basic ability to speak, understand, read, and write (if that language has a written form). You can learn more languages after character creation via a variety of means, including training during downtime (the time between active on-screen adventures). Gaining basic proficiency in a language requires interacting with someone who is fluent in that language daily over a period of 6 months (24 game weeks on Quartus). This time can be broken up, but spending more than a week without at least one day (8 hours) spent in practice with someone who knows the language means you lose that month's progress. This time cost is reduced by 1 week for every +1 to your Intelligence.
