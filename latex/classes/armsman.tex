...
\noindent\textbf{Hit Dice:} 1d10 per armsman level

\noindent\textbf{Hit Points at 1st Level:} 10 + your Constitution modifier

\noindent\textbf{Hit Points at Higher Levels:} 1d10 (or 6) + your Constitution modifier per armsman level after 1st

\subsubsection{Proficiencies}

\noindent\textbf{Armor:} All armor, shields

\noindent\textbf{Weapons:} All weapons

\noindent\textbf{Tools:} None

\noindent\textbf{Saving Throws:} Strength, Constitution

\noindent\textbf{Skills:} Choose two skills from Acrobatics, Animal, Handling, Athletics, History, Insight, Intimidation, Perception, and Survival
