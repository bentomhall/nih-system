...
\DndMonsterDetails[saving-throws={Wis +2}, skills={}, damage-immunities={necrotic, poison}, damage-resistances={}, damage-vulnerabilities={fire}, condition-immunities={charmed, exhaustion, frightened, paralyzed, poisoned}, senses={darkvision 60 ft., passive Perception 10}, languages={the languages it knew in life}, challenge={4:4}]
\DndMonsterSection{Actions}
...
\begin{DndMonster}{Shadow}
	...
	\DndMonsterAttack[
		...
		dmg=\DndDice{2d6 + 2},
		dmg-type=necrotic,
		extra={, and the target's Strength score is reduced by 1. The target dies if this would reduce its Strength below -5. Otherwise, the reduction lasts until the target finishes a short or long rest. If a humanoid dies from this attack, a new shadow rises from the corpse 2 hours later.}
	]
\end{DndMonster}
