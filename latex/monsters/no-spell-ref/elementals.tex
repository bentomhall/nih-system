...
\begin{DndMonster}{Dust Mephit}
	...
	\DndMonsterAction{Innate Spellcasting (1/Day)} The mephit can innately cast \textit{sleep}, requiring no material components. Its innate spellcasting ability is Charisma, DC 10.
...
\begin{DndMonster}{Magma Mephit}
	...
	\DndMonsterAction{Innate Spellcasting (1/Day)} The mephit can innately cast \textit{heat metal} (spell save DC 11), requiring no material components.
...
\begin{DndMonster}{Steam Mephit}
	...
	\DndMonsterAction{Innate Spellcasting (1/Day)} The mephit can innately cast \textit{blur}, requiring no material components.
