...
\begin{DndMonster}[width=\textwidth + 8pt]{Aboleth}
\begin{multicols}{2}
...
\begin{DndMonster}[width=\textwidth + 8pt]{Animated Armor}
\begin{multicols}{2}
...
\subsection{Couatl}
\begin{DndMonster}[width=\textwidth + 8pt]{Couatl}
\begin{multicols}{2}
...
\DndMonsterDetails[saving-throws={Con +5, Wis +7, Cha +6}, skills={}, damage-immunities={psychic; bludgeoning, piercing, and slashing from nonmagical attacks}, damage-resistances={radiant}, damage-vulnerabilities={}, condition-immunities={}, senses={truesight 120 ft., passive Perception 15}, languages={all, telepathy 120 ft.}, challenge={4}]
...
\subsection{Dretch}
\begin{DndMonster}[width=\textwidth + 8pt]{Dretch}
\begin{multicols}{2}
...
\end{DndMonster}
\subsection{Erinyes}
\begin{DndMonster}[width=\textwidth + 8pt]{Erinyes}
\begin{multicols}{2}
