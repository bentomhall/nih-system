...
\subparagraph*{Hit Dice} 1d10 per oathbound level

\subparagraph*{Hit Points at 1st Level} 10 + your Constitution modifier

\subparagraph*{Hit Points at Higher Levels} 1d10 (or 6) + your Constitution modifier per oathbound level after 1st

\subsubsection{Proficiencies}

\subparagraph*{Armor} All armor, shields

\subparagraph*{Weapons} Simple weapons, martial weapons

\subparagraph*{Tools} None

\subparagraph*{Saving Throws} Wisdom, Charisma

\subparagraph*{Skills} Choose two from Athletics, Insight, Intimidation, Medicine, Persuasion, and Religion
...
\subparagraph*{Thunderous Smite} By expending 2 additional aether, you can force the target to make a Strength saving throw against your spell DC. On a failed save, the target is pushed 10 feet away from you and knocked prone.
...
\subsubsection{Tenets of Sin's Weight}

\subparagraph{Sin is Painful, but Pain is Unavoidable} No Sinner \textit{wants} to sin. They do not glory in it---they prefer if they can avoid it. But sometimes, sin must happen that righteousness may prevail.
...
\subparagraph{The Meaning of Sin is Personal} Most Sinners agree that demons and undead are evil. But each Sinner has his or her personal crusade, the thing that he or she considers \textit{particularly} sinful, that they are willing to stain their souls to fight. Choose something (in coordination with your GM) that fits your character.
...
\begin{itemize}
	...
	\item Your attacks deal extra fire or necrotic (your choice) damage equal to one roll of the weapon's base damage die. Damage dealt by Divine Smite or Improved Divine Smite becomes that same damage type.
...
\subsection{Oath of Retribution}
Those who take the Oath of Retribution are generally those who have lost something or someone dear to them at the hand of a villain or foe. For some, this villain is concrete---the Lord of Castle Keep, who murdered their daughter---for others, it may be as abstract as "those who enslave others" or "the gods themselves". Importantly, their target is individual to them. Of all the Oaths, this is the one least likely to have an organization or order backing them. Lone wolves, joining with the party out of shared motives or because their paths happened to coincide for a while. An oathbound of Retribution devotes themselves to the destruction of their sworn foe and all those who assist or aid them. Generally, good backstories for oathbound of Retribution \textit{generalize} to match the campaign's themes---if your sworn foe is one specific person, there's really no good path for the character if the campaign steers the party away from that person or if they're defeated early on. In a campaign with a narrow focus, a narrow foe works best. In a more open-ended campaign, a more open-ended sworn foe is more appropriate.

\subsubsection{Tenets of Retribution}
\subparagraph*{All for Vengeance} I will give up anything and do anything to acheive my vengeance.
\subparagraph*{Break a Few Eggs} Collateral damage is sometimes necessary in the course of vengeance, but cycles of vengeance are costly. Only break eggs when necessary.
\subparagraph*{The Enemy of My Enemy} Sometimes I will need to join forces with evil to defeat greater evil. But I should remember that it is still evil.
...
\subsubsection{Scorn the Unworthy}
