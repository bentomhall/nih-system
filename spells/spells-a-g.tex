...
{When you use more than 8 AET to cast this spell, the damage dealt increases by 1d6 for every two AET you spend up to 12 (dealing 5d6).}
...
\DndSpellHeader{Detect Evil and Good}
{2 AET}
{1 action}
{Self}
{V, S}
...
\DndSpellHeader{Dispel Evil and Good}
{12 AET}
{1 action}
{Self}
...
\subparagraph*{Bear's Endurance} The target has advantage on Constitution checks. It also gains 2d6 temporary hit points, which are lost when the spell ends.
