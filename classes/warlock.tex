...
\begin{figure*}[htb]
\begin{DndTable}[header=The Warlock]{llXlllllllll}
...
You are continually under the effect of the \nameref{inc:detect-aura} incantation as long as you are conscious. You can change which variety you are detecting as an action.
...
\begin{DndTable}[header=Destruction Spells, width=0.5\linewidth]{lX}
