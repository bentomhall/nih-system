...
A monster with the Spellcasting special trait has the ability to cast selected spells, which it uses to cast its spells (as explained in the _Player’s Handbook_).
...
Some monsters have spell attacks. These count as cantrips for _counterspell_ and other features for that care about spells. Generally, they do not require components and are specialized for that creature. 
