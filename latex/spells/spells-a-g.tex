...
\subparagraph*{Overcast} When you cast this spell using more than 3 AET, the damage (both initial and subsequent) increases by 1d6 for every 2 AET you spend above 3.
...
\DndSpellHeader{Aetheric Barrier \label{spell:aetheric-barrier}}
...
\subparagraph*{Overcast} When you cast this spell using more than 8 AET, you can target one additional creature for every 3 additional AET you spend. Creatures save or not individually, but ending concentration affects all banished creatures.
...
\item While cursed, the target has disadvantage on attack rolls.
...
\subparagraph*{Overcast} If you cast this spell using 8 AET, the duration is concentration, up to 10 minutes. If you use 12 AET,the duration is 8 hours. If you use 16 AET, the duration is 24 hours. Using 12 or more AET grants a duration that doesn't require concentration and lasts at least 8 hours (more at 16 AET).
...
\DndSpellHeader(Caustic Torrent\label{spell:caustic-torrent})
{8 AET}
{1 action}
{Self (30ft cone)}
{V, S, M (a drop of vinegar)}
{Concentration, up to 1 minute}
...
When you cast this spell, choose either \textbf{creeping fog} or \textbf{rolling fog}. If you chose creeping fog, the fog spreads 5 ft at the beginning of each of your turns until it reaches a maximum of a 50 ft radius. If you chose rolling fog, the center of the fog moves 10 feet in a direction you chose at the start of each of your turns, rolling along the surface of the ground. The vapors, being heavier than air, sink to the lowest level of the land, even pouring down openings.

\subparagraph*{Overcast} When you cast this spell using more than 14 AET , the damage increases by 1d8 for every 2 additional AET spent.
...
\subparagraph*{Seizure} The creature is overcome with shaking. The creature has disadvantage on Dexterity checks, Dexterity saving throws, and attack rolls that use Dexterity and cannot concentrate on spells or abilities.

\subparagraph*{Slimy Doom} The creature begins to bleed uncontrollably. The creature has disadvantage on Constitution checks and Constitution saving throws. In addition, whenever the creature takes damage, it is staggered until the end of its next turn.
...
\DndSpellHeader{Dominate Unthinking\label{spell:dominate-beast}}
{8 AET}
{1 action}
{60 feet}
{V, S}
...
\DndSpellHeader{Envenom\label{spell:envenom}}
{2 AET}
{1 bonus action}
{Touch}
{S, M (a drop of spider or snake venom)}
{Concentration, up to 1 minute}
...
\subparagraph*{Overcast} When you cast this spell and spend more than 2 AET, you can target an additional weapon or container of ammunition for every 2 AET spent above 2.
