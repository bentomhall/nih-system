...
\noindent\textbf{Hit Dice:} 1d6 per arcanist level

\noindent\textbf{Hit Points at 1st Level:} 6 + your Constitution modifier

\noindent\textbf{Hit Points at Higher Levels:} 1d6 (or 4) + your Constitution modifier per arcanist level after 1st

\subsection{Proficiencies}

\noindent\textbf{Armor:} None

\noindent\textbf{Weapons:} Daggers, darts, slings, quarterstaffs, light crossbows

\noindent\textbf{Tools:} None

\noindent\textbf{Saving Throws:} Constitution, Intelligence

\noindent\textbf{Skills:} Choose two from Arcana, Deception, Insight, Intimidation, Persuasion, and Religion
