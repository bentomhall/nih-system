...
Design Goals: The priest is the basic full-caster divine class, replacing the cleric. Their UCT is Miracles--basically Divine Intervention, but starting earlier. Their subclasses give bonuses to various types of spells, basically adding riders.

Subclasses:
\begin{itemize}
	\item Life Domain: healing-focused support.
	\item Battle domain: Gets armor and weapons and an ersatz Extra Attack.
...
\subparagraph*{Hit Dice} 1d8 per priest level

\subparagraph*{Hit Points at 1st Level} 8 + your Constitution modifier

\subparagraph*{Hit Points at Higher Levels} 1d8 (or 5) + your Constitution modifier per priest level after 1st

\subsubsection{Proficiencies}

\subparagraph*{Armor} Light armor, shields
...
\subparagraph*{Skills} Choose two from History, Insight, Medicine, Persuasion, and Religion
...
Starting at 2nd level, when you use your Miracles ability to plead for healing for a \nameref{condition:bloodied} creature, the result on the miracle check is increased by one step.
