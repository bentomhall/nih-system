...
\noindent\textbf{Hit Dice:} 1d8 per rogue level

\noindent\textbf{Hit Points at 1st Level:} 8 + your Constitution modifier

\noindent\textbf{Hit Points at Higher Levels:} 1d8 (or 5) + your Constitution modifier per rogue level after 1st

\subsubsection{Proficiencies}

\noindent\textbf{Armor:} Light armor

\noindent\textbf{Weapons:} Simple weapons, hand crossbows, longswords, rapiers, shortswords, acid vials, flasks of alchemist fire

\noindent\textbf{Tools:} Thieves' tools

\noindent\textbf{Saving Throws:} Dexterity, Intelligence

\noindent\textbf{Skills:} Choose four from Acrobatics, Athletics, Deception, Insight, Intimidation, Investigation, Perception, Performance, Persuasion, Sleight of Hand, and Stealth
