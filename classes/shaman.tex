...
\begin{itemize}
	\item You learn the Resurrection incantation, and count as a priest of the Life domain when performing it.
...
\onecolumn
\begin{DndTable}[header=Shaman Spell List]{XXY}
