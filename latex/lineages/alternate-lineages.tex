...
Every adventurer has a few parts that pre-exist their adventuring life. Who they are, what they did before they became adventurers, and what kind of creature they are. Effectively, this breaks down into the biological, the socio-cultural, and the individual backgrounds. We call those, respectively, Lineage, Culture, and Background. Backgrounds are presented in \nameref{sec:backgrounds}; cultures in \nameref{sec:cultures}. Lineages are presented first in \nameref{sec:lineages}.
...
\item Status. One of "core", "regional X", and "rare. Core lineages are found everywhere and raise no especial eyebrows. Regional lineages are common/normal in region X, but will raise eyebrows elsewhere. Rare lineages raise eyebrows everywhere. This element has fewer \textit{direct} gameplay effects, but has significant narrative effects. NPCs may or may not change how they treat you based on how common your lineage is in that region.
\item Some combination of features. One minor feature only counts as half of a major feature; each lineage has the equivalent of 2 major features. Features marked with (+) are for use with the Touched template, which replaces one lineage feature from a base lineage with one caused by exposure to extra-planar forces.
\end{itemize}
...
\item Feature. One major-equivalent feature. Culture features are not replaced by plane-touched features.
\end{itemize}

\section{Lineages}\label{sec:lineages}
...
\subparagraph*{Age}  adult at 16, live until 80-ish
...
\subparagraph*{Age}  physically adult at 20, live until 150-ish
...
\subparagraph*{Age}  adult at 20, live until 120-ish
...
\subparagraph*{Trance}  Instead of sleeping, you remain semi-conscious and aware of your surroundings. You still require 6 hours of trance to complete a long rest. You can not be magically put to sleep.

\subparagraph*{Naturally Stealthy} Your connection with the land makes you able to hide more easily. While on the Mortal Plane, you can attempt to Hide as long as you are in an area of dim light or are lightly obscured.
...
\subparagraph*{Age}  physically adult at 12, lives until 70-ish, although 80 is not uncommon.
...
\subparagraph*{Trance}  Instead of sleeping, you remain semi-conscious and aware of your surroundings. You still require 6 hours of trance to complete a long rest. You cannot be magically put to sleep.
...
\subparagraph*{Small}  You can move through the space of any creature that is of a size larger than yours as if was difficult terrain.

\subparagraph*{Diminutive Target}  When you would gain half cover from an obstacle or creature, you gain 3/4 cover instead.
...
\subparagraph*{Entwining Limbs}  When you successfully grapple a creature, you can make them restrained instead. If you do so, you cannot move them forcibly without releasing them from restraint (but not the grapple).
...
The steelborn soulforged, along with their mirrors the shrine guardians, are the youngest lineage of Quartus. In the wake of the Fourth Wish approximately 50 years ago, metal clockwork labor constructs across Wyrmhold started to "wake up", becoming ensouled living beings made of metal, stone, and crystal. Not all of them--only a tiny fraction. No one knows \textit{why} this is happening, or how long they will live. Or how to cause one to awaken. Unlike most, they do not visibly change over time--their appearance at the time of their awakening is how they will look throughout their lives unless they modify their own appearance, something many steelborn engage in. It is rare for a non-humanoid-shaped construct to awaken, and this playable lineage presumes that you are humanoid in shape (bilateral symmetry with a distinct head and torso).
...
\subparagraph*{Age}  Undefined. No soulforged is more than 40 years old, but adulthood is not defined nor is a maximum age known.

\subparagraph*{Size}  Medium. Usually 5'6"+, 200-400 lbs

\subparagraph*{Speed}  30ft
\subparagraph*{Status}  regional (Western Noefra). Cannot be -touched.
...
\subparagraph*{Living Construct}  You are immune to disease and do not require food or air. You do "sleep" normally, however, and are affected by poisons, including conventionally-inhaled ones. No one knows why.

\subsection{Soulforged, Shrine Guardian} \label{lineage:shrine-guardian}

The shrine guardians, along with their counterparts the steelborn, are the youngest lineage of Quartus. In the wake of the Fourth Wish approximately 40 years ago, magically-animated wood-and-stone shrine guardian golems started to "wake up", becoming ensouled living beings made of wood and stone. Not all of them--only a tiny fraction. No one knows \textit{why} this is happening, or how long they will live. Or how to cause one to awaken. Unlike most, they do not visibly change over time--their appearance at the time of their awakening is how they will look throughout their lives unless they modify their own appearance, although shrine guardians tend to be less free with this than the steelborn.
...
\subparagraph*{Shielding Stone}  As a reaction when you or a creature you can see within 30' of you is hit by an attack, you can take the Deflect action without expending Stamina, affecting the creature targeted. This effect lasts until the start of your next turn. You can use this trait a number of times equal to half your proficiency bonus, regaining expended uses when you finish a long rest.
