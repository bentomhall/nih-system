...
\begin{DndMonster}[width=\textwidth + 8pt]{Animated Furniture}
...
\begin{DndMonster}[width=\textwidth + 8pt]{Golem, FLesh}
\DndMonsterType{Medium construct}
...
\DndMonsterAction{Construct Resilience} Any damage dealt to the golem except by adamantine weapons and thunder is reduced by 12. This reduction cannot reduce the damage taken below 0. Critical hits bypass this damage reduction.
