...
Magical, opaque darkness spreads from a point you choose within range to fill a 15-foot-radius sphere for the duration. The darkness spreads around corners. A creature with darkvision can't see through this darkness, and nonmagical light can't illuminate it.
...
\subparagraph*{Overcast} When you cast this spell and spend at least 12 AET, the duration is concentration, up to 10 minutes. When you use at least 15 AET, the duration is concentration, up to 1 hour. When you use at least 18 AET, the duration is concentration, up to 8 hours.
...
\subparagraph*{Overcast} When you cast this spell using more than 11 AET, the fire damage and the radiant damage each increase by 1d6 for every 3 additional AET spent.
