...
\begin{DndMonster}{Ghoul}
	...
	\DndMonsterAttack[
		...
		dmg=\DndDice{2d4 + 2},
		dmg-type=slashing,
		extra={. If the target is a creature other than an undead or construct, it must succeed on a DC 10 Constitution saving throw or be \nameref{condition:staggered} for 1 minute. If the save result is 5 or less, the target is instead \nameref{condition:paralyzed}. The target can repeat the saving throw at the end of each of its turns, ending the effect on itself on a success.}
	]
