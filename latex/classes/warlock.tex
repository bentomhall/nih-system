...
Design Discussion: This one's going to change a lot. The goal is to move toward the 3e version, with most things tied up in (class feature) eldritch blast + blast shapes + essences. Spellcasting will come only via invocations that grant the ability to grab specific spells off of specific (full-caster) lists. Only class that will get a familiar.
...
\subparagraph*{Hit Dice} 1d8 per warlock level

\subparagraph*{Hit Points at 1st Level} 8 + your Constitution modifier

\subparagraph*{Hit Points at Higher Levels} 1d8 (or 5) + your Constitution modifier per warlock level after 1st

\subsubsection{Proficiencies}

\subparagraph*{Armor} Light armor

\subparagraph*{Weapons} Simple weapons

\subparagraph*{Tools} None

\subparagraph*{Saving Throws} Wisdom, Charisma

\subparagraph*{Skills} Choose two skills from Arcana, Deception, History, Intimidation, Investigation, Nature, and Religion
...
\subsubsection{Chainbound familiar}
...
\subsubsection{Boon-blade}

You can use your \textit{eldritch blast} to create a magical weapon of solidified aether in your hand. It takes the form and statistics of any melee weapon. You have proficiency with this weapon even if you normally would not. You make spell attacks, not melee attacks with this weapon. You can apply blast effects to it by expending AET as normal. The first time you hit with this weapon on a turn, the damage dealt is equal to your \textit{eldritch blast} damage instead of the normal weapon damage if this would be greater.
...
\subsubsection{Boon of the Grimoire}
...
\textit{Prerequisite: 12th level, Boon-blade feature}
...
\textit{Prerequisite: 5th level, Boon-blade feature}
...
\textit{Prerequisite: Chain-bound familiar feature}
...
Targets hit by your \textit{eldritch blast} are pulled 5 feet toward you for every aether spent. If they are more than two sizes larger than you are, they can make a Strength saving throw to halve the distance they are moved.
...
Targets of your \textit{eldritch blast} must make a Wisdom saving throw instead of you making an attack roll. On a failed save, they are frightened of you until the end of your next turn and take the full damage as psychic damage. On a successful save they take half damage as psychic damage and are not frightened.
...
Make an unarmed attack using Charisma as your weapon attack modifier. On a hit, apply your \textit{eldritch blast} damage and any Blast Effects. This counts as slashing damage. This is not compatible with effects that exchange the attack roll for a saving throw.
...
\subsubsection{Legendary Effect: Mind Blank}
