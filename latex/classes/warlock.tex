...
\noindent\textbf{Hit Dice:} 1d8 per warlock level

\noindent\textbf{Hit Points at 1st Level:} 8 + your Constitution modifier

\noindent\textbf{Hit Points at Higher Levels:} 1d8 (or 5) + your Constitution modifier per warlock level after 1st

\subsubsection{Proficiencies}

\noindent\textbf{Armor:} Light armor

\noindent\textbf{Weapons:} Simple weapons

\noindent\textbf{Tools:} None

\noindent\textbf{Saving Throws:} Wisdom, Charisma

\noindent\textbf{Skills:} Choose two skills from Arcana, Deception, History, Intimidation, Investigation, Nature, and Religion
