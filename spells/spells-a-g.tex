...
\DndSpellHeader{Chain Lightning}
{13 AET}
{1 action}
{150 feet}
...
\label{spell:dispel-otherworldly-influence}
\DndSpellHeader{Dispel Otherworldly Influence}
{12 AET}
{1 action}
{Self}
...
\label{spell:enhance-ability} %todo rewrite me
...
\label{spell:flash-freeze}
\DndSpellHeader{Flash Freeze}
{2 AET}
{1 action}
{60 feet}
{V, S}
